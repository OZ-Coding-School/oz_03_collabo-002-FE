import { ReactComponent as IconPaginationLeft } from '../assets/icon/icon-pagination-left.svg';
...
import { ReactComponent as IconReviewStarEmpty } from '../assets/icon/icon-review-star-empty.svg';
